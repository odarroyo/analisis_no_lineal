...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{@{} l X l X @{}}
        \textbf{Profesor:} & Prof. Orlando Arroyo, Ph.D. & \textbf{Duración:} & 4 Semanas (Posgrados) \\
...
El sistema de evaluación se articula en torno a un \textbf{Proyecto Práctico de Modelación No Lineal} desarrollado a lo largo de las 4 semanas del curso en dos entregas consecutivas que concentran el \textbf{90\%} de la calificación final, complementado por un \textbf{Quiz Final} conceptual correspondiente al \textbf{10\%}.

\vspace{0.10cm}

\begin{table}[H]
\centering
\caption{Esquema oficial de evaluación de la asignatura (Posgrados --- 4 Semanas).}
...
\toprule
\textbf{Actividad Evaluativa} & \textbf{Alcance, Enfoque y Entregables en Moodle UIS} & \textbf{Porcentaje} & \textbf{Cronograma} \\
\midrule
